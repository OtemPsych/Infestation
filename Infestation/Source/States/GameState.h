...
private:
	...
	void cleanupBloodSplatters(sf::Time dt);
...
private:
	...
	std::vector<std::pair<pyro::SpriteNode*, sf::Time>> blood_splatters_;
	const sf::Time                                      blood_splatter_lifetime_;
	...
	unsigned short                                      wave_;
	unsigned                                            infected_per_wave_;
	pyro::Text*                                         wave_text_;
	sf::Font                                            wave_font_;
